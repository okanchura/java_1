...
public class Test8 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("Дано целое число A = " + a);
		
		//double A = Math.sqrt(a*a);
		//double A = Math.sqrt(Math.pow(2, a));
		//double A = Math.pow(2, a);// как определить что является степенью?
		//boolean b = A%2 == 0; 
	

	//System.out.println("число является степенью 2? " + b);
